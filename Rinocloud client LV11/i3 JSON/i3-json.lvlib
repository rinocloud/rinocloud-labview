...
<Library LVVersion="11008008">
	...
	<Item Name="JSON Generation" Type="Folder">
		<Item Name="Add Object Parameter Files" Type="Folder">
			...
			<Item Name="Add Object Parameter - Data JSON string.vi" Type="VI" URL="../JSON Generation/Add Object Parameter Files/Add Object Parameter - Data JSON string.vi"/>
		...
		<Item Name="Append to Array Files" Type="Folder">
			...
			<Item Name="Append to Array - data JSON string.vi" Type="VI" URL="../JSON Generation/Append to Array Files/Append to Array - data JSON string.vi"/>
		...
		<Item Name="Create Value Files" Type="Folder">
			...
			<Item Name="Create Value - Array.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Array.vi"/>
			<Item Name="Create Value - Boolean.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Boolean.vi"/>
			<Item Name="Create Value - data JSON string.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - data JSON string.vi"/>
			<Item Name="Create Value - Known Type.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Known Type.vi"/>
			<Item Name="Create Value - Null.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Null.vi"/>
			<Item Name="Create Value - Numeric.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Numeric.vi"/>
			<Item Name="Create Value - Object.vi" Type="VI" URL="../JSON Generation/Create Value Files/Create Value - Object.vi"/>
